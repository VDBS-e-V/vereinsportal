...
HTML,
        ...
        $placeholders = [
            [
                ...
                'description' =>
                    'Signierter Link zur Bestätigung der neuen E-Mail-Adresse.',
                'example_value' =>
                    'https://my.vdb.test/email/aenderung/bestaetigen/example',
                'is_required' => true,
            ],
            [
                'key' => 'expires_at',
                ...
                'description' =>
                    'Zeitpunkt, bis zu dem die Bestätigung möglich ist.',
                'example_value' =>
                    '06.09.2026 22:00',
                'is_required' => true,
            ],
            ...
            [
                ...
                'description' =>
                    'Aktuell hinterlegte E-Mail-Adresse.',
                'example_value' =>
                    'alt@example.test',
                'is_required' => false,
            ],
            [
                ...
                'description' =>
                    'Zu bestätigende neue E-Mail-Adresse.',
                'example_value' =>
                    'neu@example.test',
                'is_required' => false,
            ],
