    ...
    public function run(): void
    {
        $template =
            EmailTemplate::query()
                ->firstOrCreate(
                    [
                        'key' => 'auth.two_factor.email_code',
                    ],
                    [
                        'name' => 'Zwei-Faktor-Code',
                        'is_active' => false,
                        'draft_subject' => 'Ihr Sicherheitscode',
                        'draft_html' => <<<'HTML'
...
HTML,
        ...
        $placeholders = [
            [
                ...
                'description' => 'Einmaliger Code für die Zwei-Faktor-Anmeldung.',
            ...
            [
                ...
                'description' => 'Gültigkeitsdauer des Sicherheitscodes.',
                'example_value' => '15',
                'is_required' => true,
            ],
            [
            ...
            [
                ...
                'description' => 'Kontaktadresse bei Sicherheitsfragen.',
