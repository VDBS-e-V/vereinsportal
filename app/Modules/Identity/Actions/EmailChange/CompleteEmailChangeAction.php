...
final class CompleteEmailChangeAction
{
    ...
    public function execute(
        ...
        $emailCandidate = EmailChangeRequest::query()
        ...
        $lockedEmail = EmailNormalizer::normalize($emailCandidate);
                ...
                function () use (
                    ...
                    return DB::transaction(
                        function () use (
                            ...
                            $newEmail = EmailNormalizer::normalize(
                                $request->new_email
                            );
                            ...
                            $currentPersonEmail = EmailNormalizer::normalize(
                                $person->email
                            );

                            $currentUserEmail = EmailNormalizer::normalize(
                                $user->email
                            );

                            $expectedOldEmail = EmailNormalizer::normalize(
                                $request->old_email
                            );

                            if (
                                $currentPersonEmail !== $expectedOldEmail
                                || $currentUserEmail !== $expectedOldEmail
                            ) {
                                throw EmailChangeCannotComplete::invalidOrExpired();
                            }
                            ...
                            $request->status = EmailChangeRequestStatus::Confirmed;
